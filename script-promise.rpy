...
label mshMod_promise:
    ...
    m 2eka "Thank you for trusting me."
        m "Are you really sure you want to make this promise?"
        m "To try your best not to harm yourself, and stay sober?"
        menu:
            "Yes, I promise."
                m "..."
                m 3ekb "And I promise I'll do my best to help you!"
    ...
    return "love"
            ...
            "No, I'm not ready yet."
                m "It's okay, [player]!"
                m "I'm proud of you regardless."
                m "If you ever change your mind, please let me know, okay?"
                m "Your story is not over yet!"
                m 2dka "..."
                m 5ekbsb "I love you, [mas_get_player_nickname()]."
                m 5dkbsb "Never forget that!"
