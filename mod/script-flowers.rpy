...
label mshMod_topic_sunflowers:
    ...
    m 1dua "Sunflowers are yellow; the color of joy, happiness and hope... "
    ...
    m 5fsbsa "Am I your sunflower, [player]? "
    extend 5hsbsb "Ahaha~"
...
label mshMod_topic_hyacinths:
    ...
    m "I'll read some of its verses to you!"
    m "..."
    m "{i}'You gave me hyacinths first a year ago;'{/i}"
    m "{i}'They called me the hyacinth girl.'{/i}"
    m "{i}—Yet when we came back, late, from the Hyacinth garden,{/i}"
    m "{i}Your arms full, and your hair wet, I could not{/i}"
    m "{i}Speak, and my eyes failed, I was neither{/i}"
    ...
    m "The hyacinth is the flower of the sun god Apollo and is a symbol of peace, rebirth, commitment and beauty, but also of power and pride."
