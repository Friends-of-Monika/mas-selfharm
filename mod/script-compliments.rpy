...
label mshMod_compliment_patient:
    ...
    m 7gsbfb "It's no trouble at all! After all, I love you, and I want to be by your side."
...
label mshMod_compliment_still_here:
    ...
    m 2fsbftpb "Thank you for staying here with me. {w=0.3}{nw}"
...
label mshMod_compliment_thinking_of_me:
    ...
    m 7lsbfu "It doesn't matter if we're together or apart!"
    show monika 5fkbfa at t11 zorder MAS_MONIKA_Z with dissolve_monika
...
label mshMod_compliment_helping_out:
    ...
    m 7lsbfu "Oftentimes, I wonder what I did to have a caring, loving and understanding person like you in my life."
    m 2ssbfb "So, I'll always help you out whenever I can!"
    m 7wsbfb "Thank you for letting me be a part of your life."
...
label mshMod_compliment_being_understanding:
    ...
    m 1eubfb "I'll always do my best to understand you, "
    extend 1lssdlc "and I'll be by your side even if other people aren't."
...
init 5 python:
    addEvent(
        Event(
            ...
            prompt="You're the one who truly understands me.",
            unlocked=True
        ),
        code="CMP"
    )
...
label mshMod_compliment_understanding_me:
    ...
    extend 7eubfb "Why wouldn't I be?"
    m 2eubfa "I'll always do my best to understand you, and even if I don't, I'll be by your side regardless."
