...
label mshMod_topic_morning_routine:
    ...
    m 1hub "Now with that extra time, use it to get some quiet time in for yourself and actually {i}wake up{/i} for the day. "
    extend 1lua "Maybe do a little meditation- or pray,if you'religious... Make breakfast, read books, or even write down your plans for day."
    m 3lub "As long as it's something that {i}you{/i} want to do and makes you happy, go for it!"
    m 3lusdld "Just... try not to go online during your morning time. "
    extend 3eusdlc "With how chaotic the world and internet can be, going online might influence your mood for the day if you see something distressing or weird."
